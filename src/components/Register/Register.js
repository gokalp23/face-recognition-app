...
class Register extends React.Component {
	...
	onSubmitSignIn = () => {
		fetch('https://sheltered-sierra-89331.herokuapp.com/register', {
			method: 'post',
				  ...
				  <div className="measure">
					    <fieldset id="sign_up" className="ba b--transparent ph0 mh0">
					      ...
					      <div className="mt3">
					        ...
					        <input onChange={this.onNameChange} className="pa2 input-reset ba bg-transparent hover-bg-black hover-white w-100" type="text" name="fullname"  id="fullname" />
					      </div>
					      <div className="mt3">
